/* Part 1: Polling-based LED control using KEY pushbuttons
   KEY0 pressed and released -> all 10 LEDs turn on
   KEY1 pressed and released -> all 10 LEDs turn off
...
int main(void) {
    volatile int *LED_ptr = (int *)LEDR_BASE;     // pointer to LED data register
