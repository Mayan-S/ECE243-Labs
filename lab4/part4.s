...
main_loop:
    ...
    beqz s4, main_loop              # If stopped during wait, do not increment
...
init_timer:
    ...
    sw zero, 0(t0)                  # Clear the timeout bit in status register
...
timer_poll_loop:
    ...
    andi t1, t1, 0x1                # Mask the timeout bit (bit 0)
...
increment_clock:
    ...
    ble a0, t0, clock_done          # If hundredths <= 99, we are done
    ...
    ble a1, t0, clock_done          # If seconds <= 7, we are done
